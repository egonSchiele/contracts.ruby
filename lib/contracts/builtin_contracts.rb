...
module Contracts
  module BuiltinContracts
    ...
    class HashOf < CallableClass
      ...
      def to_s
        "Hash<#{formatted_key}, #{formatted_value}>"
      end
      ...
      def formatted_key
        Formatters::InspectWrapper.create(@key)
      end

      def formatted_value
        Formatters::InspectWrapper.create(@value)
      end
    end
